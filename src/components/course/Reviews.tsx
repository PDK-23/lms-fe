    ...
    <div>
      ...
      {onAdd && (
        <form
          ...
          className="mb-4 p-4 rounded bg-white border"
        >
          ...
          <div className="mt-2 flex items-center gap-4">
            {errors.name && (
              <div className="text-rose-600 text-sm">{errors.name}</div>
            )}
            {errors.rating && (
              <div className="text-rose-600 text-sm">{errors.rating}</div>
            )}
            {errors.comment && (
              <div className="text-rose-600 text-sm">{errors.comment}</div>
            )}
          </div>
        </form>
      )}
