...
export function VideoLessonPlayer({
  ...
  return (
    <div className="w-full grid grid-cols-4 fixed top-0">
      <div className="bg-white border border-neutral-200 overflow-hidden flex flex-col col-span-1 h-screen">
        {/* Header */}
        <div className="bg-neutral-50 border-b border-neutral-200 px-4 py-4">
          <h3 className="font-bold text-neutral-900">Course Contents</h3>
