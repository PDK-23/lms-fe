        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-400">
              Empower yourself with knowledge. Learn from industry experts and advance your career.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/courses" className="text-neutral-400 hover:text-primary-500 transition-colors">
                  Browse Courses
                </Link>
              </li>
              <li>
                <Link to="/categories" className="text-neutral-400 hover:text-primary-500 transition-colors">
                  Categories
                </Link>
              </li>
              <li>
                <Link to="/become-instructor" className="text-neutral-400 hover:text-primary-500 transition-colors">
