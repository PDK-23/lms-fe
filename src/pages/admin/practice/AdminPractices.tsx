  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg sm:text-xl font-semibold">Code Practices</h2>
        <div className="flex items-center gap-6">
          ...
          <Button
            ...
            onClick={() => navigate("/admin/practices/new")}
          >
            <Plus className="w-4 h-4" />
            <span className="ml-2">New Practice</span>
          </Button>
        </div>
      </div>
                  ...
                  <td className="py-3 px-2">
                    <div className="flex gap-2">
                      <Button
                        size="sm"
                        onClick={() =>
                          navigate(`/admin/practices/${p.id}/view`)
                        }
                      >
                        View
                      </Button>
                      <Button
                        className="flex gap-2 items-center"
                        size="sm"
                        onClick={() => navigate(`/admin/practices/${p.id}`)}
                      >
